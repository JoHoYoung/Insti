...
async function likeToPost(driver)
{
    return new Promise(async (resolve,reject) => {
        ...
        //await driver.executeScript("arguments[0].scrollIntoView()", element2);
        await sleep(2000)
        let test = await driver.findElement(By.css('#react-root > section > main > div > div > article > div.eo2As > section.ltpMr.Slqrh > span.fr66n > button > span')).getAttribute('class')
